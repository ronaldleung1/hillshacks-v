    ...
    return(
        <Accordion>
            ...
            <AccordionItem>
                ...
                <AccordionItemPanel>
                    <p>
                        hillsHacks is returning as a fully in-person event at <Link href="https://goo.gl/maps/se4i7cSCAxGcRvYHA" target="_blank">Watchung Hills Regional High School</Link>!
                    </p>
                </AccordionItemPanel>
            </AccordionItem>
            <AccordionItem>
            ...
            <AccordionItem>
                ...
                <AccordionItemPanel>
                    <p>
                       hillsHacks will likely charge a small fee to attend. The amount has not been finalized yet, but will be shared after the main registration opens.
                    </p>
                </AccordionItemPanel>
            </AccordionItem>
            <AccordionItem>
                ...
                <AccordionItemPanel>
                    <p>
                        No problem! We highly encourage beginners to come, and our workshops will give you opportunities to learn about fundamental CS concepts. After creating an idea as part of our design challenge, you'll be ready to implement it on your own after the event!
                    </p>
                </AccordionItemPanel>
            </AccordionItem>
            <AccordionItem>
            ...
            <AccordionItem>
                ...
                <AccordionItemPanel>
                    <p>
                        Please feel free to email us at <Link href="mailto:team@hillshacks.com">team@hillshacks.com</Link> with any questions you may have!
                    </p>
                </AccordionItemPanel>
            </AccordionItem>
        </Accordion>  
