...
const theme = {
  ...
  colors: {
    ...
    muted: colors.muted,
    gradientMid: colors.muted,
    gradientOut: colors.slate,
    light: colors.white,
    link: colors.darkyellow,

    backgroundTransparent: `${colors.white}ca`,
    ...
    modes: {
      dark: {
        ...
        sunken: colors.darkless,
        border: colors.darkless,
        placeholder: colors.slate,
        secondary: colors.smoke,
        muted: colors.muted,
        gradientMid: colors.slate,
        gradientOut: colors.darkless,
        light: colors.smoke,
        link: colors.yellow,

        backgroundTransparent: `${colors.dark}ca`,
      },
    },
  },
  fonts: {
    monospace: 'ui-monospace, "Roboto Mono", Menlo, Consolas, monospace',
    heading: `'Cabinet Grotesk', ${fonts}`,
    body: `'General Sans', ${fonts}`,
  },
  lineHeights: {
    limit: 0.875,
    title: 1,
  ...
  buttons: {
    primary: {
      ...
      ':focus,:hover': {
        boxShadow: 'elevated',
        transform: 'translateY(-4px)', // Change later
      },
    ...
    lg: {
      ...
      lineHeight: 'title',
      borderRadius: 'extra',
      background: 'linear-gradient(#fef09a, #fbd702)',
      px: 4,
      py: 3,
    },
    outline: {
